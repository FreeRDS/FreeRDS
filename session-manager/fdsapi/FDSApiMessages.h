...
#define FDSAPI_VIRTUAL_CHANNEL_OPENEX_REQUEST_ID		5
#define FDSAPI_VIRTUAL_CHANNEL_OPENEX_RESPONSE_ID		6
...
FDSAPI_VIRTUAL_CHANNEL_OPENEX_REQUEST;

typedef struct
{
	const char* endPoint;
}
FDSAPI_VIRTUAL_CHANNEL_OPENEX_RESPONSE;
...
typedef struct
{
	...
	union
	{
		...
		FDSAPI_VIRTUAL_CHANNEL_OPENEX_REQUEST virtualChannelOpenExRequest;
		FDSAPI_VIRTUAL_CHANNEL_OPENEX_RESPONSE virtualChannelOpenExResponse;
