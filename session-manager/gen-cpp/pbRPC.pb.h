...
inline void RPCBase::set_status(::freerds::pbrpc::RPCBase_RPCSTATUS value) {
  assert(::freerds::pbrpc::RPCBase_RPCSTATUS_IsValid(value));
  set_has_status();
  status_ = value;
}
...
inline void RPCBase::set_allocated_payload(::std::string* payload) {
  if (payload_ != &::google::protobuf::internal::kEmptyString) {
    delete payload_;
  }
  if (payload) {
...
inline void RPCBase::set_allocated_errordescription(::std::string* errordescription) {
  if (errordescription_ != &::google::protobuf::internal::kEmptyString) {
